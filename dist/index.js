...
var EmptyStateRow = ({ show, colSpan, message }) => {
  if (!show) return null;
  return /* @__PURE__ */ jsxRuntime.jsx("tr", { children: /* @__PURE__ */ jsxRuntime.jsx("td", { colSpan, className: `px-2 py-3 text-center ${T.empty}`, children: message }) });
};
    ...
    tableshell_default,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs("table", { className: T.table, style: { tableLayout: "fixed" }, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("tbody", { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(emptystaterow_default, { show: entries.length === 0, colSpan: 5, message: "Sin informaci\xF3n tributaria" })
        ] })
      ] })
    }
  );
...
var AssetTable = ({
      ...
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("td", { className: `px-2 py-2.5 text-gray-700 ${T.cellLabel}`, style: { width: "200px" }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntime.jsx(deletebutton_default, { onClick: () => requestDelete(row.id), isVisible: hovered, size: "default", title: "Eliminar fila" }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
                type: "text",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "rounded-xl overflow-hidden border border-gray-200 bg-white", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntime.jsxs("table", { className: T.table, style: { tableLayout: "fixed" }, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(recyclebin_default2, { deletedRows, getLabel: (r) => r.label, onRestore: restoreRow })
    ] }),
    deleteTargetId && /* @__PURE__ */ jsxRuntime.jsx(deletedialog_default, { count: 1, onConfirm: confirmDelete, onCancel: cancelDelete })
  ] });
};
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "overflow-x-auto", onKeyDown: keyboard.handleContainerKeyDown, tabIndex: 0, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("table", { className: T.table, style: { tableLayout: "fixed" }, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("tbody", { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(emptystaterow_default, { show: activeRows.length === 0, colSpan: 5, message: emptyMessage }),
          /* @__PURE__ */ jsxRuntime.jsx("tr", { className: "border-b border-dashed border-slate-100 bg-slate-50/20", children: /* @__PURE__ */ jsxRuntime.jsx("td", { colSpan: 5, className: "px-4 py-2.5 text-center", children: /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "overflow-x-auto", onKeyDown: keyboard.handleContainerKeyDown, tabIndex: 0, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("table", { className: T.table, style: { tableLayout: "fixed" }, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("tbody", { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(emptystaterow_default, { show: activeRows.length === 0, colSpan: 5, message: emptyMessage }),
          /* @__PURE__ */ jsxRuntime.jsx("tr", { className: "border-b border-dashed border-emerald-100 bg-emerald-50/20", children: /* @__PURE__ */ jsxRuntime.jsx("td", { colSpan: 5, className: "px-4 py-2.5 text-center", children: /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "overflow-x-auto", onKeyDown: keyboard.handleContainerKeyDown, tabIndex: 0, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("table", { className: T.table, style: { tableLayout: "fixed" }, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("tbody", { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(emptystaterow_default, { show: activeRows.length === 0, colSpan: 7, message: "Sin deudas de consumo registradas" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "overflow-x-auto relative", onKeyDown: keyboard.handleContainerKeyDown, tabIndex: 0, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("table", { className: T.table, style: { tableLayout: "fixed" }, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("tbody", { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(emptystaterow_default, { show: activeRows.length === 0, colSpan: totalCols, message: "Sin bienes ra\xEDces registrados" }),
          /* @__PURE__ */ jsxRuntime.jsx("tr", { className: "border-b border-dashed border-amber-100 bg-amber-50/20", children: /* @__PURE__ */ jsxRuntime.jsx("td", { colSpan: totalCols, className: "px-4 py-2.5 text-center", children: /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
