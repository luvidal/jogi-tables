    ...
    /* @__PURE__ */ jsxs("div", { className: "overflow-x-auto", onKeyDown: keyboard.handleContainerKeyDown, tabIndex: 0, children: [
      /* @__PURE__ */ jsxs("table", { className: T.table, children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: `${headerBg} border-t ${borderColor} ${headerText}`, children: anySelected ? /* @__PURE__ */ jsx("th", { colSpan: 8, className: `${T.headerCell} text-left`, onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("th", { className: `${T.headerCell} text-left ${T.th} ${headerText}`, children: "Instituci\xF3n" }),
          /* @__PURE__ */ jsx("th", { className: `${T.headerCell} text-left ${T.th} ${headerText}`, children: "Tipo Deuda" }),
          /* @__PURE__ */ jsx("th", { className: `${T.headerCell} text-right ${T.th} ${headerText} ${T.colFit}`, children: "Saldo UF" }),
          /* @__PURE__ */ jsx("th", { className: `${T.headerCell} text-right ${T.th} ${headerText} ${T.colFit}`, children: "Saldo $" }),
          /* @__PURE__ */ jsx("th", { className: `${T.headerCell} text-right ${T.th} ${headerText} ${T.colFit}`, children: "Cuota $" }),
          /* @__PURE__ */ jsx("th", { className: `${T.headerCell} text-center ${T.th} ${headerText} ${T.colFit}`, children: "%" }),
          /* @__PURE__ */ jsx("th", { className: `${T.headerCell} text-center ${T.th} ${headerText} ${T.colFit}`, children: "Cuotas" }),
          /* @__PURE__ */ jsx("th", { className: T.colFit, style: { width: "40px" } })
        ] }) }) }),
        /* @__PURE__ */ jsxs("tbody", { children: [
          activeRows.map((row) => {
            ...
            return /* @__PURE__ */ jsxs(
              "tr",
              {
                ...
                onDrop: drag.handleDrop(rows, onRowsChange),
                children: [
                  /* @__PURE__ */ jsxs("td", { className: `${T.cellEditLabel} ${T.cellLabel} relative`, children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: T.cellEdit, children: /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ jsxs("td", { className: `relative ${T.colFit}`, children: [
                    /* @__PURE__ */ jsx(
                      editablecell_default,
                      {
                  ...
                  /* @__PURE__ */ jsx("td", { className: `text-center ${T.colFit}`, children: row.cuota_estimated ? /* @__PURE__ */ jsx(
                    editablecell_default,
                    {
                  ...
                  /* @__PURE__ */ jsx("td", { className: `text-center text-xs text-gray-500 ${T.colFit}`, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-0.5", children: [
                    /* @__PURE__ */ jsx(
                      editablecell_default,
                      {
                  ...
                  /* @__PURE__ */ jsx("td", { className: `text-center ${T.colFit}`, style: { width: "40px" }, children: /* @__PURE__ */ jsx(deletebutton_default, { onClick: () => requestDelete(row.id), isVisible: hovered && !anySelected }) })
                ]
              },
              row.id
            );
          ...
          /* @__PURE__ */ jsxs("tr", { className: `border-b border-dashed ${borderColor.replace("200", "100")} ${headerBg}/20`, children: [
            ...
            /* @__PURE__ */ jsx("td", { className: T.colFit }),
            /* @__PURE__ */ jsx("td", { className: T.colFit }),
            /* @__PURE__ */ jsx("td", { className: T.colFit }),
            /* @__PURE__ */ jsx("td", { className: T.colFit }),
            /* @__PURE__ */ jsx("td", { className: T.colFit }),
            /* @__PURE__ */ jsx("td", { className: T.colFit, style: { width: "40px" } })
          ] })
        ] }),
            ...
            return /* @__PURE__ */ jsxs(
              "tr",
              {
                ...
                children: [
                  resolvedColumns.map((col) => {
                    if (col.isLabel) {
                      return /* @__PURE__ */ jsx("td", { className: `${T.cellEdit} ${T.cellLabel}`, style: col.width ? { width: col.width } : void 0, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 min-w-0", children: [
                    ...
                    if (col.type === "text") {
                      ...
                      return /* @__PURE__ */ jsx("td", { className: T.cellEdit, style: col.width ? { width: col.width } : void 0, children: /* @__PURE__ */ jsx(
                        "input",
                        {
                          type: "text",
                          value: row[col.key] || "",
        ...
        recyclebin_default,
        {
          ...
          renderCells: (row) => /* @__PURE__ */ jsxs(Fragment, { children: [
            editableCols.map((col) => {
              const v = row[col.key];
              return /* @__PURE__ */ jsx("td", { className: `${T.totalCell} text-right tabular-nums`, style: col.width ? { width: col.width } : void 0, children: /* @__PURE__ */ jsx("span", { className: `${T.totalValue} ${v != null ? "text-gray-400" : "text-gray-200"}`, children: v != null ? col.type === "number" ? String(v) : formatCurrency(v) : "\u2014" }) }, col.key);
            }),
            /* @__PURE__ */ jsx("td", { style: { width: "40px" } })
          ] })
        }
